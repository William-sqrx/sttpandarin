...
# ----- Fish generator (defined in fishgen.py) -----
# Importing the module also registers its FastAPI APIRouter, which
# exposes /fishgen + /api/fishgen/* endpoints. PixelLab + OpenAI keys
# come from the same env (PIXELLAB_SECRET, OPENAI_API_KEY).
